...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_provider_types_code"), "provider_types", ["code"], unique=True
    )
    op.create_index(
        op.f("ix_provider_types_id"), "provider_types", ["id"], unique=False
    )
    op.create_table(
        "validation_rules",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_validation_rules_id"), "validation_rules", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_validation_rules_rule_type"),
        "validation_rules",
        ["rule_type"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_base_requirements_id"), "base_requirements", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_base_requirements_requirement_type"),
        "base_requirements",
        ["requirement_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_provider_requirements_id"),
        "provider_requirements",
        ["id"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_provider_requirements_id"), table_name="provider_requirements"
    )
    op.drop_table("provider_requirements")
    op.drop_index(
        op.f("ix_base_requirements_requirement_type"), table_name="base_requirements"
    )
